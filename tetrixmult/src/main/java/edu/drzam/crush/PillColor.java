...
public enum PillColor {
	...
	TypePillLB(new Color(LivePanel.COLOR_MIN, LivePanel.COLOR_MAX, LivePanel.COLOR_MAX), 1, 1, 1, new boolean[][]{
		{
			true,
		}
	}),
	...
	TypePillBlue(new Color(LivePanel.COLOR_MIN, LivePanel.COLOR_MIN, LivePanel.COLOR_MAX), 1, 1, 1, new boolean[][]{
		{
			true,
		}
	}),
	...
	TypePillPink(new Color(LivePanel.COLOR_MAX, LivePanel.COLOR_MIN, LivePanel.COLOR_MAX), 1, 1, 1, new boolean[][]{
		{
			true,
		}
	}),
	...
	TypePillYllw(new Color(LivePanel.COLOR_MAX, LivePanel.COLOR_MAX, LivePanel.COLOR_MIN), 1, 1, 1, new boolean[][]{
		{
			true,
		}
	}),
	...
	TypePillRed(new Color(LivePanel.COLOR_MAX, LivePanel.COLOR_MIN, LivePanel.COLOR_MIN), 1, 1, 1, new boolean[][]{
		{
			true,
		}
	});
